...
#]
    ...
    for i in range(6): # len(dates)-1
        ...
        # Extract sheet data
        companies, weights, emissions, _ = extract_sheet_data(file, sheet_name)
        ...
        optimized_weights = average_optimizer(predicted_average_values, emissions, weights, current_values)
